...
const Search = ({navigation}) => {
  ...
  useEffect(() => {
    // Filter the search array based on the searchKey
    const filteredResults = search.filter(item => item.location.toLowerCase().includes(searchKey.toLowerCase()));
