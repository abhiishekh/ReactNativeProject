...
return (
  <SafeAreaView>
    ...
    {filteredHotels.length === 0 && searchKey !== '' ? (
      <View>
        <HeightSpacer height={'10%'} />
        <ReusableText
                text={"Hotel not Found!!🙅🏻‍♂️"}
                family="medium"
                size={SIZES.xLarge}
                color={COLORS.black}
                align="center"
      ...
      <View style={{ paddingLeft: 15 }}>
        <FlatList
          data={filteredHotels.length > 0 ? filteredHotels : hotels}
